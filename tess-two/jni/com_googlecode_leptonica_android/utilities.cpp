...
jlong Java_com_googlecode_leptonica_android_GrayQuant_nativePixThresholdToBinary(JNIEnv *env,
                                                                                 jclass clazz,
                                                                                 jlong nativePix,
                                                                                 jint thresh) {
    PIX *pixs = (PIX *) nativePix;
...
jlong Java_com_googlecode_leptonica_android_Scale_nativeScaleGeneral(JNIEnv *env, jclass clazz,
                                                                     ...
                                                                     jint sharpwidth) {
    PIX *pixs = (Pix *) nativePix;
    return (jlong) pixScaleGeneral(pixs, (l_float32) scaleX, (l_float32) scaleY,
                                   (l_float32) sharpfract, (l_int32) sharpwidth);
}
