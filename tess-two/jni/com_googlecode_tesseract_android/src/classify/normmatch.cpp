...
double_VAR(classify_norm_adj_midpoint,
32.0, "Norm adjust midpoint ...");
double_VAR(classify_norm_adj_curl,
2.0, "Norm adjust curl ...");
 ...
 */
    NORM_PROTOS *Classify::ReadNormProtos(FILE *File, inT64 end_offset) {
        ...
        NormProtos->Protos = (LIST * )
        Emalloc(NormProtos->NumProtos * sizeof(LIST));
