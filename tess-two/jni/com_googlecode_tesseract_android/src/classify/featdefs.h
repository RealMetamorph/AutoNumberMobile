...
----------------------------------------------------------------------*/
void TESS_API
InitFeatureDefs(FEATURE_DEFS_STRUCT
*featuredefs);
...
ReadCharDescription(const FEATURE_DEFS_STRUCT &FeatureDefs,
                    FILE *File);

int TESS_API

ShortNameToFeatureType(const FEATURE_DEFS_STRUCT &FeatureDefs,
...
extern TESS_API const FEATURE_DESC_STRUCT
PicoFeatDesc;
