...
//  2 - the word is inconsistent.
    ...
    public:
        ...
        double_VAR_H(segment_penalty_ngram_best_choice,
        1.24,
        ...
        0, "Set to 1 for general debug info"
        ", to 2 for more details, to 3 to see all the debug messages");
        INT_VAR_H(hyphen_debug_level,
        0, "Debug level for hyphenated words.");
        INT_VAR_H(max_viterbi_list_size,
        10, "Maximum size of viterbi list.");
        ...
        INT_VAR_H(fragments_debug,
        0, "Debug character fragments");
