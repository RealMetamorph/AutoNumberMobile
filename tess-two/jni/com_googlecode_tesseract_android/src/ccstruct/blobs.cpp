...
int TBLOB::ComputeMoments(FCOORD * center, FCOORD * second_moments)
const {
...
void TBLOB::GetPreciseBoundingBox(TBOX * precise_box)
const {
TBOX box = bounding_box();
*
precise_box = TBOX();
CollectEdges(box, precise_box,
NULL, NULL, NULL);
precise_box->
move(box
.
