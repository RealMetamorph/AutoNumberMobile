        ...
        \n__kernel void morphoDilateHor(__global int *sword, __global int *dword, const int xp, const int xn, const int wpl, const int h)
{
        ...
        unsigned int parbitsxp, parbitsxn, nwords;
                ...
                unsigned int lnextword, lprevword, rnextword, rprevword,
        firstword, secondword;
                ...
                for (i = 1; i <= parbitsxp; i++) {
                    //Get the max value on LHS of every pixel
                    tempword = ((i == parbitsxp) &&
                                (parbitsxp != parbitsxn)) ? 0x0 :
                ...
                for (i = 1; i < nwords; i++) {
                    ...
                    lprevword = firstword << (32 - parbitsxn) |
                                secondword >> parbitsxn;
                    ...
                    lnextword = firstword << (32 - parbitsxn) |
                                secondword >> parbitsxn;
                    ...
                    rnextword = firstword << parbitsxp |
                                lastword >> (32 - parbitsxp);
                    ...
                    rprevword = firstword << parbitsxp |
                                lastword >> (32 - parbitsxp);

                    for (j = 1; j < 32; j++) {
                        //OR LHS full words
                        tempword =
                                (lprevword << j) | (lnextword >> (32 - j));
                        destword |= tempword;

                        //OR RHS full words
                        tempword =
                                (rprevword << j) | (rnextword >> (32 - j));
                        destword |= tempword;
                    }
        ...
        const int h, const char isAsymmetric, const int rwmask, const int lwmask)
{
        ...
        firstword, secondword;
                ...
                for (i = 1; i <= parbitsxp; i++) {
                    ...
                    //Get max value on RHS of every pixel
                    tempword = ((i == parbitsxp) &&
                                (parbitsxp != parbitsxn)) ? 0xffffffff :
                ...
                for (i = 1; i < nwords; i++) {
                    ...
                    lprevword = firstword << (32 - parbitsxp) |
                                secondword >> (parbitsxp);
                    ...
                    lnextword = firstword << (32 - parbitsxp) |
                                secondword >> (parbitsxp);
                    ...
                    rnextword = firstword << parbitsxn |
                                lastword >> (32 - parbitsxn);
