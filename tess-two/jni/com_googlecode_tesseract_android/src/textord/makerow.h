...
extern BOOL_VAR_H(textord_heavy_nr, FALSE,
...
extern BOOL_VAR_H (textord_test_landscape, FALSE,
...
extern BOOL_VAR_H (textord_old_baselines, TRUE,
"Use old baseline algorithm");
extern BOOL_VAR_H (textord_old_xheight, TRUE,
"Use old xheight algorithm");
extern BOOL_VAR_H (textord_fix_xheight_bug, TRUE,
"Use spline baseline");
...
extern BOOL_VAR_H (textord_debug_xheights, FALSE,
...
extern double_VAR_H (textord_spline_outlier_fraction,
0.1,
...
extern BOOL_VAR_H(textord_debug_blob, FALSE,
