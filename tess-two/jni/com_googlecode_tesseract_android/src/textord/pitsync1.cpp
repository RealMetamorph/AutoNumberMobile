...
#define EXTERN
EXTERN
INT_VAR (pitsync_linear_version,
6, "Use new fast algorithm");
EXTERN
double_VAR (pitsync_joined_edge,
0.75,
...
void make_illegal_segment(                          //find segmentation
        ...
        TBOX
blob_box,             //bounding box
BLOBNBOX_IT blob_it,      //iterator
        inT16
region_index,       //number of segment
inT16 pitch,              //pitch estimate
        inT16
