    ...
    void Textord::to_spacing(
        ...
        for (block_it.mark_cycle_pt(); !block_it.cycled_list();
            ...
            if (tosp_old_to_method && tosp_old_to_constrain_sp_kn &&
                ...
                block_non_space_gap_width = (inT16)
                floor(block_space_gap_width / 3.0);
            }
 ...
 *************************************************************************/
    TBOX Textord::reduced_box_for_blob(
        ...
        */
        ...
        return TBOX(ICOORD((inT16)
        floor(left_limit), blob_box.bottom()),
        ICOORD((inT16)
        ceil(right_limit), blob_box.top()));
    }
}  // namespace tesseract
