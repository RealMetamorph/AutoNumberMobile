...
extern BOOL_VAR_H (textord_show_new_words, FALSE,
"Display separate words");
extern BOOL_VAR_H (textord_show_fixed_words, FALSE,
"Display forced fixed pitch words");
extern BOOL_VAR_H (textord_blocksall_fixed, FALSE,
...
extern BOOL_VAR_H (textord_test_mode, FALSE,
"Do current test");
...
0.05,
"Smoothing gap stats");
extern double_VAR_H (textord_width_smooth_factor,
0.10,
"Smoothing width stats");
extern double_VAR_H (textord_words_width_ile,
0.4,
...
extern double_VAR_H (textord_spacesize_ratiofp,
2.8,
...
extern double_VAR_H (textord_fp_min_width,
