 ...
 */
    class TESS_API TessTextRenderer
 ...
 */
class TESS_API TessHOcrRenderer
 ...
 * Renders tesseract output into a plain UTF-8 text string
 */
class TESS_API TessUnlvRenderer
 ...
 * Renders tesseract output into a plain UTF-8 text string
 */
class TESS_API TessBoxTextRenderer
 ...
 */
class TESS_API TessOsdRenderer
