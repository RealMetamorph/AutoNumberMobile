...
/* ccmain/tstruct.cpp *********************************************************/
    ...
    public:
        ...
        "after merging");
        BOOL_VAR_H(wordrec_no_block, FALSE,
        "Don't output block information");
        BOOL_VAR_H(wordrec_enable_assoc, TRUE,
        "Associator Enable");
        ...
        double_VAR_H(wordrec_worst_state,
        1, "Worst segmentation state");
        ...
        1, "Fix blobs that aren't chopped");
        double_VAR_H(tessedit_certainty_threshold,
        -2.25, "Good blob limit");
        ...
        false, "Print blamer debug messages");
        BOOL_VAR_H(wordrec_run_blamer,
        false, "Try to set the blame for errors");
        INT_VAR_H(segsearch_debug_level,
        0, "SegSearch debug level");
