...
jobjectArray
Java_com_googlecode_tesseract_android_ResultIterator_nativeGetSymbolChoices(JNIEnv *env,
                                                                            jclass clazz,
                                                                            jlong nativeResultIterator) {
    ...
    jobjectArray ret = (jobjectArray) env->NewObjectArray(numberOfAlternatives,
...
jboolean Java_com_googlecode_tesseract_android_ResultIterator_nativeIsAtFinalElement(JNIEnv *env,
    ...
    return (jboolean) (resultIterator->IsAtFinalElement(enumLevel, enumElement) ? JNI_TRUE
                                                                                : JNI_FALSE);
}
